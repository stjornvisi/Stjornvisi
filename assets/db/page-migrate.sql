...
Forseti Íslands hr. Ólafur Ragnar Grímsson hefur afhent verðlaunin við hátíðlega athöfn í Veisluturninum Kópavogi.
...
Það er Stjórnvísi mikið í mun að verðlaunin séu byggð á faglegu mati og hefur því verið vandað verulega til dómnefndar.
...
##Viðmið dómnefndar
Viðmið (e. criteries), sem dómnefnd leggur til grundvallar tilnefningum til Stjórnunarverðlaunanna eru eftirfarandi:

###I. Árangursstjórnun
Í starfi sínu stuðlar stjórnandinn að:

+ Framgangi stefnu fyrirtækisins / stofnunarinnar
...
+ Frumleika
+ Nýjum hugmyndum
+ Nýjum aðferðum og bættu vinnulagi

###III. Forysta
Stjórnandinn er:

+ Er óskoraður leiðtogi
+ Stuðlar að frelsi til athafna
+ Nýtur virðingar út fyrir eigin fyrirtæki / stofnun

###IV. Rekstrarumhverfi
Stjórnandinn:

+ Stuðlar að samkeppnisforskoti með skarpri framtíðarsýn og þekkingu á þörfum viðskiptavina
+ Hefur góðan skilning á atvinnugreininni ásamt samkeppnisaðilum og tengslum þessara aðila innbyrðis og við samfélagið" where id = 1;